...
var CategoryController = /** @class */ (function () {
    ...
    CategoryController.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, text, recipeId, createReq, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, comment_1.Comment.create(String(req.user.id), recipeId, text)];
                    case 2:
                        createReq = _b.sent();
                        res.json({
                            ok: true,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, comment_1.Comment.deleteComment(id)];
                    case 2:
                        deleteReq = _a.sent();
                        res.json({
                            ok: true,
