...
var RecipeController = /** @class */ (function () {
    ...
    RecipeController.create = function (req, res) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, recipe_1.RecipeModel.createRecipe(title, description, category, req.user.id, photoInfo.filename, ingridiens)];
                    case 2:
                        createReq = _b.sent();
                        _b.label = 3;
                    case 3:
    ...
    RecipeController.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var reqErrors, photoInfo, recipeId, _a, title, description, category, ingridiens, oldPath, photoPath, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        reqErrors = express_validator_1.validationResult(req);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, recipe_1.RecipeModel.editRecipe(recipeId, title, description, category, photoPath, ingridiens)];
                    case 2:
                        _b.sent();
    ...
    RecipeController.getOne = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, recipe_1.RecipeModel.getOneRecipe(String(recipeId))];
                    case 2:
                        reicpeData = _a.sent();
                        if (!reicpeData) {
                            res.json({
    ...
    RecipeController.getList = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, offset, _c, limit, search, filter, parsedFilter, foundRecipes, err_3;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, recipe_1.RecipeModel.getAllRecipes(+offset, +limit, parsedFilter.filter, search, Number(parsedFilter.category_id))];
                    case 2:
    ...
    RecipeController.delete = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, recipe_1.RecipeModel.getShortRecipeById(recipeId)];
                    case 2:
                        recipe = _a.sent();
                        ...
                        return [4 /*yield*/, recipe_1.RecipeModel.deleteRecipe(recipeId)];
                    case 3:
                        deleteReq = _a.sent();
                        res.json({
                            ok: true,
